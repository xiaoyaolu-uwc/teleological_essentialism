...
source of proportion error (see eval/PROPORTION_EVAL_RESULTS.md), and raising
...
Usage:
    python3 eval/calibrate_gate_threshold.py
"""
import argparse
import csv
import json
...
def main():
    ...
    ap.add_argument("--out", default="eval/results/proportions/threshold_calibration.json")
    args = ap.parse_args()
