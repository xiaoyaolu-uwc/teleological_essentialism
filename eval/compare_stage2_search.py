...
========================
Ranks the stage-2 config-search runs (eval/results/lora/s2_*) by the metric
...
seed noise (see eval/lora_prompt_evolution.md's multi-seed reliability pass).

Usage:
    python3 eval/compare_stage2_search.py [--results-dir eval/results/lora]
"""
import argparse
import json
import statistics
...
def main():
    ...
    ap.add_argument("--results-dir", default="eval/results/lora")
    args = ap.parse_args()
