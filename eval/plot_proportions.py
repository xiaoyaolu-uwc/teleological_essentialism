...
plot_proportions.py
===================
Three figures from eval/results/proportions/proportion_metrics.json:
...
Usage: python3 eval/plot_proportions.py
"""
import json
...
def main():
    r = json.load(open("eval/results/proportions/proportion_metrics.json"))
    ...
    plt.tight_layout()
    out = Path("eval/results/proportions/proportion_figures.png")
