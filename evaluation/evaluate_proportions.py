...
evaluation/run_cascade_folds.py and produces every number the blog post needs.
...
Usage:
    python3 evaluation/evaluate_proportions.py \
        --per-row evaluation/results/proportions/per_row_predictions.csv \
        --out-dir evaluation/results/proportions
"""
import argparse
import csv
import json
...
def main():
    ...
    ap.add_argument("--out-dir", default="evaluation/results/proportions")
    args = ap.parse_args()
