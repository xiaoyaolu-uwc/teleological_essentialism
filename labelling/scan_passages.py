...
from models.prompts import SYSTEM_PROMPT, USER_PROMPT_TEMPLATE, PASSAGE_TEMPLATE, VALID_TAGS
...
# Prompts and valid tags are loaded from prompts.py (imported above).
