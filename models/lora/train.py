...
confirmed bottleneck (see docs/history/LORA_JUNK_GATE_PLAN.md and
docs/history/bert_cascade_evolution.md).
...
Single holdout only -- Reign of Law, per docs/history/LORA_JUNK_GATE_PLAN.md section 9
...
from models.labels import STAGE_LABELS, stage_tag
from models.torch_utils import get_device, evaluate, compute_class_weights
from models.lora.model import (
...
def seed_everything(seed):
    ...
    for the hyperparameter sweep in docs/history/LORA_JUNK_GATE_PLAN.md to mean anything:
...
# task being stated explicitly. See docs/history/LORA_JUNK_GATE_PLAN.md section 3 for why
...
PROMPT_VARIANTS = {
    ...
    # Round 1 of the prompt-iteration loop (see docs/history/lora_prompt_evolution.md).
    ...
    # not a broad new sweep -- see docs/history/lora_prompt_evolution.md.
